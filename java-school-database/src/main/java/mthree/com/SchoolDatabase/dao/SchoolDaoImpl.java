...
public class SchoolDaoImpl implements SchoolDao {
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT courseCode, courseDesc, COUNT(cs.student_id) AS numStudents FROM course c JOIN course_student cs ON c.cid = cs.course_id GROUP BY c.cid, c.courseCode, c.courseDesc";
        // YOUR CODE ENDS HERE
